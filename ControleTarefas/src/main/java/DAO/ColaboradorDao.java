...
public class ColaboradorDao implements GenericDAO<Colaborador> {
    ...
    // Metodo para INSERIR colaborador na tabela Colaborador
    @Override
    public boolean include(Colaborador colaborador) throws SQLException {
    ...
    // Metodo para ALTERAR colaborador da tabela Colaborador
    @Override
    ...
    // Metodo para EXCLUIR colaborador da tabela Colaborador
    @Override
    ...
    public List<Colaborador> findAll() throws SQLException {
        this.query = "select * from colaborador order by nomeColaborador ;";
        try {
            PreparedStatement statement = this.connection.getConnection().prepareStatement(query);
